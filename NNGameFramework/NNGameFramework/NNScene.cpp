...
void NNScene::Render()
{
	...
	m_Matrix = D2D1::Matrix3x2F::Rotation( m_Camera.GetRotation(), D2D1::Point2F(m_Camera.GetPositionX()+m_Camera.GetCenterX(),m_Camera.GetPositionY()+m_Camera.GetCenterY()) ) *
